...
menu=Start latest MINIX 3:load_mods /boot/minix_latest/mod*; multiboot /boot/minix_latest/kernel rootdevname=c0d0p0 acpi=yes cttyline=0 no_smp=0 no_apic=0
