...
menu=Start MINIX 3 in SMP mode:load_mods /boot/minix_default/mod*; multiboot /boot/minix_latest/kernel rootdevname=c0d0p0 acpi=yes no_apic=0 no_smp=0
menu=Start MINIX 3 in single user mode:load_mods /boot/minix_default/mod*; multiboot /boot/minix_latest/kernel rootdevname=c0d0p0 bootopts=-s
