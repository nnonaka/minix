...
static void bios_cons_stop(void);
static void bios_scr_init(struct tty *tp);
static int bios_con_loadfont(endpoint_t endpt, cp_grant_id_t grant);
static void bios_select_console(int cons_line);

cons_sw_t bios_cons_sw = {
	bios_scr_init,
	bios_con_loadfont,
	bios_cons_stop,
	bios_select_console,
 ...
 *				scr_init				     *
 *===========================================================================*/
static void bios_scr_init(tty_t *tp)
{
