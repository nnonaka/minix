...
#define PAF_USERMEM	0x80	/* Ordinary user memory: honor the low-memory
				 * reserve so a user process cannot exhaust the
				 * pages that system services need to stay alive.
				 */
